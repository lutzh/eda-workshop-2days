...
| 12:30 -- 13:30 | *Lunch break* |
| 13:30 -- 14:15 | **Operations and Observability** -- Logs, metrics, and traces for EDA, distributed tracing, correlation and causation IDs, consumer lag, scaling, schema registries. |
| 14:15 -- 15:00 | **Stream Processing and Event Sourcing** -- Event streams for analytics and data lakes, stream processing concepts, event sourcing as a microarchitecture pattern, how it relates to (and differs from) EDA. |
| 15:00 -- 15:15 | *Coffee break* |
| 15:15 -- 15:45 | **Schema Evolution** -- Non-breaking vs. breaking changes, compatibility modes, rolling out breaking changes, bootstrapping new services. |
| 15:45 -- 16:45 | **Patterns, Anti-Patterns, Q&A, Final Exercise** |
